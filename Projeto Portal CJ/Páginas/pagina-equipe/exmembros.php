                  ...
                  <nav class="espaco-membros">
                        <nav class="row" id="fundo-branco">
                              ...
                              <nav class="col-md-4 col-md-offset-1" id="membros">
                                    ...
                                    <p class="curso">Sistemas de Informação - Enésimo período</p>
                                    <p class="email">gustavo@compjunior.com.br</p>
                                    <p>Curriculum</p> 
                              </nav>
                        </nav>
                  </nav>       
                  ...
                  <nav class="espaco-membros">
                        <nav class="row" id="fundo-branco">
                              <nav class="col-md-3 col-md-offset-2" id="membros">
                                    ...
                                    <p class="curso">Sistemas de Informação - Nono período</p>
                                    <p class="email">souza.gioconda@compjunior.com.br</p>
                                    <p>Curriculum</p>  
                              </nav>
                              <nav class="col-md-3 col-md-offset-2">
