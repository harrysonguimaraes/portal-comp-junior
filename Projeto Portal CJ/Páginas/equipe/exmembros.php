...
<html lang="pt-br">
      ...
      <body>
            ...
            <nav class="area-titulo">
                  ...
                  <p id="titulo-cargo">Ex-Membros</p>
            </nav>

            <nav class="container-fluid">
                  <nav class="espaco-membros">
                        <nav class="row" id="fundo-branco">
                              <nav class="col-md-3 col-md-offset-2 col-xs-offset-2">
                                    <img src="img/gustavo.png" class="foto-membro">                              
                              </nav>
                              <nav class="col-md-4 col-md-offset-2" id="membros">
            ...
            <nav class="container-fluid">
                  <nav class="espaco-membros">
                        <nav class="row" id="fundo-branco">
                              <nav class="col-md-3 col-md-offset-2 col-md-push-5 col-xs-offset-2">
                                    <img src="img/gioconda.png" class="foto-membro">                              
                              </nav>
                              <nav class="col-md-3 col-md-offset-2 col-md-pull-5" id="membros">
